...
from GeniusRobot.modules.helpers.parser import mention_html, mention_markdown



@Client.on_message(command(["admins", "adminlist"]) & genius_filters)
...
@Client.on_message(command(["kickdel", "zombies"]) & genius_filters)
...
@Client.on_message(command(["reportadmin", "reportadmins", "report"]) & genius_filters)
...
@Client.on_message(command(["everyone", "tagall"]) & genius_filters)
...
@Client.on_message(command(["botlist", "bots"]) & genius_filters)
