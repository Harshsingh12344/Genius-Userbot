...
@Client.on_message(filters.user(SUDO_USERS) & command(["replyraid", "rraid", "rr"]))
@Client.on_message(filters.me & command(["replyraid", "rraid", "rr"]))
...
@Client.on_message(filters.user(SUDO_USERS) & command(["dreplyraid", "drraid", "drr"]))
@Client.on_message(filters.me & command(["dreplyraid", "drraid", "drr"]))
